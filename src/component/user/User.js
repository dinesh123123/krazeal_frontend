          ...
          if (!input.password) {
            ...
            setPasswordError("Password must be one character")   
                ...
                const data = {
                 ...
                 axios.post('http://103.104.74.215:3003/website/update_userdata', data,options).then(res => {
                      ...
                      <div className="order-contain">
                        <div className="order-box dashboard-bg-box">
                          ...
                          <div className="product-order-detail">
                            <a href="/product-left-thumbnail" className="order-image">
                  ...
                  <div className="tab-pane fade show" id="pills-address" role="tabpanel" aria-labelledby="pills-address-tab">
                    <div className="dashboard-address">
                      <div className="title title-flex">
                        ...
                        <button className="btn theme-bg-color text-white btn-sm fw-bold mt-lg-0 mt-3" data-bs-toggle="modal" data-bs-target="#add-address"><svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="feather feather-plus me-2"><line x1={12} y1={5} x2={12} y2={19} /><line x1={5} y1={12} x2={19} y2={12} /></svg> Add New Address</button>
                      </div>
                      <div className="row g-sm-4 g-3">
                              ...
                              <table className="table">
                                <tbody>
                                  ...
                                  <tr>
                                    <td>Phone Number :</td>
                                    <td>
                                      <a href="javascript:void(0)"> +91 {localStorage.getItem("phone")}</a>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>Address :</td>
